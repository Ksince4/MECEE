...
1. Va dans **Releases** (colonne de droite) ou clique le lien ci-dessus.
2. Télécharge le fichier **`MECEE.exe`**.
3. Lance-le. Une fenêtre de connexion s'ouvre : entre les identifiants
